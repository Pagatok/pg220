...
public class CarteTactiqueFactory {
    public static List<Carte_Tactique> creerCartesTactiques() {
        ...
        cartesTactiques.add(new Carte_Tactique("Joker",
                "Peut prendre n'importe quelle couleur et valeur au moment de la revendication.", Carte_Tactique.Type.TROUPES_ELITE)); //Chaque joueur ne peut avoir qu’un seul Joker de son côté de la frontière.
        cartesTactiques.add(new Carte_Tactique("Joker",
                "Peut prendre n'importe quelle couleur et valeur au moment de la revendication.", Carte_Tactique.Type.TROUPES_ELITE));
        cartesTactiques.add(new Carte_Tactique("Espion",
                "Carte de valeur 7 avec couleur choisie au moment de la revendication.", Carte_Tactique.Type.TROUPES_ELITE));
        cartesTactiques.add(new Carte_Tactique("Porte-Bouclier",
                "Carte de valeur 1, 2 ou 3 avec couleur choisie au moment de la revendication.", Carte_Tactique.Type.TROUPES_ELITE));
